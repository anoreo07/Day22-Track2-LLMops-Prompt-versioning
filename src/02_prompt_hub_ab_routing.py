...
PROMPT_V1_NAME = "haiann-rag-prompt-v1"
PROMPT_V2_NAME = "haiann-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI thân thiện. Trả lời ngắn gọn, rõ ràng dựa trên context được cung cấp. "
    "Nếu không tìm thấy thông tin, hãy nói thẳng 'Tôi không tìm thấy thông tin này'."
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích AI. Khi trả lời hãy thực hiện: "
    "1) Tóm tắt câu trả lời chính, "
    "2) Trích dẫn thông tin cụ thể từ context, "
    "3) Nêu rõ mức độ chắc chắn. "
    "Chỉ dựa trên dữ liệu được cung cấp, không suy đoán hoặc thêm thông tin ngoài context."
)
